...
% Dados
veiculoDados = 2; % Não ocorre variação dos dados do veículo
...
title(strcat('Âng. de deriva - Esterçamento: 14 graus - Veículo: ',veiculoModeloTxt(i,:)));
...
ylabel('Distância [m]')
xlabel('Distância [m]')
legend(pneuModeloTxt(1,:),pneuModeloTxt(2,:),pneuModeloTxt(3,:),'Location','West')
