...
% Neste script o ângulo de esterçamento do pneu dianteiro é de 45 graus e as condições iniciais nulas
...
for i = 1:length(veiculoModeloVet)
	for j = 1:length(pneuModeloVet)
		...
		% Tempo para simulação i = 3 e j = 3 modificado para caber no gráfico
		if i == 3 && j ==2
			T = 0.5;
		end
