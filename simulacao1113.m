...
veiculoDados = 3; % Escolha dos dados do veículo
...
%% Salvando as figuras
print(f1,'resultados/simulacao1113/estados.pdf','-dpdf')
print(f2,'resultados/simulacao1113/orientacao.pdf','-dpdf')
print(f3,'resultados/simulacao1113/Trajetoria.pdf','-dpdf')
print(f4,'resultados/simulacao1113/deriva.pdf','-dpdf')
