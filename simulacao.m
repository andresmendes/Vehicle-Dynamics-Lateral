...
% 	2 - veiculoNaoLinear2gdlDados
% 	3 - veiculoNaoLinear3gdlDados
% 	4 - veiculoNaoLinear3gdlExtendidoDados

% Seleção
pneuModelo = 3; % Escolha do modelo de pneu
pneuDados = 3; % Escolha dos dados do pneu

veiculoModelo = 2; % Escolha do modelo de veículo
...
print(f1,'resultadosSimulacao/estados.pdf','-dpdf')
print(f2,'resultadosSimulacao/orientacao.pdf','-dpdf')
print(f3,'resultadosSimulacao/Trajetória.pdf','-dpdf')
print(f4,'resultadosSimulacao/deriva.pdf','-dpdf')

%% Animação
cd animacao % Entrando na pasta de animação
% Executando o script de animação
animacao(XOUT,TOUT,ALPHAF,ALPHAR,VF,VR,VT,veiculoDados);
