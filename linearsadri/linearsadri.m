...
ALPHAT = asin(vy/v); % Angulo de deriva para o cálculo das velocidades

% Modulo do vetor velocidade
VF = sqrt((v*sin(ALPHAT) + a*r).^2 + (v*cos(ALPHAT)).^2); % Dianteiro
VR = sqrt((v*sin(ALPHAT) - b*r).^2 + (v*cos(ALPHAT)).^2); % Traseiro
