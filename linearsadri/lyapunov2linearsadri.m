function [Texp,Lexp]=lyapunov2linearsadri(n,VEICULODADOS,PNEUDADOS,tstart,stept,tend,ystart,ioutp);
%
...
%rhs_ext_fcn
  [T,Y] = ode45(@(t,x) linearsadrilyapunovext(t,x,VEICULODADOS,PNEUDADOS),[t t+stept],y);  
