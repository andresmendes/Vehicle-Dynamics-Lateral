%% Estudo comparação - dPSI = 3 rad/s sem Sadri
...
% ALPHAT0 = 0 rad.
%
% Como o modelo Sadri não obteve resultado satisfatório em
% <estudoComparacaoDpsi3com.html Comparação - dPSI = 3 Com> ele foi
% retirado deste estudo para que o resutado dos modelos de pneu pudessem
...
pneuModeloVet = [1 3]; % Vai ser o número de curvas em cada figura
...
pneuModeloTxt = char('Linar','Pacejka');
pneuModeloCor = char('r','b');
pneuModeloMarcador = char('o','d');
pneuDadosVet = [1 4];
...
xlabel('Tempo [s]')
legend(pneuModeloTxt(1,:),pneuModeloTxt(2,:),'Location','SouthEast')
